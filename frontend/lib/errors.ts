...
export type ErrorKind = "unsupported_format" | "missing_dependency" | "too_large" | "not_found" | "network" | "clipboard_blocked" | "budget_cannot_fit" | "unknown";
 ...
 */
export function triageError(kind: ErrorKind, message?: string, file?: string): TriageResult {
  switch (kind) {
